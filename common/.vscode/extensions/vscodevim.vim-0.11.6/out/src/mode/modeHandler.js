    ...
    updateView(vimState, args = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (args.drawSelection) {
                let selections;
                const selectionMode = vimState.currentMode === mode_1.ModeName.SearchInProgressMode
                ...
                if (!vimState.isMultiCursor) {
                    ...
                    else if (selectionMode === mode_1.ModeName.Normal || selectionMode === mode_1.ModeName.Insert) {
                        selections = [];
            ...
            */
            ...
            for (let i = 0; i < this.vimState.postponedCodeViewChanges.length; i++) {
                ...
                vimState.allCursors = yield util_1.allowVSCodeToPropagateCursorUpdatesAndReturnThem(0);
            }
